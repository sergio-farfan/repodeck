...
![RepoDeck dashboard](https://raw.githubusercontent.com/sergio-farfan/repodeck/a531054/docs/screenshot.png)
<!-- 404s until the repo is public and docs/screenshot.png is committed — attach the image directly on dev.to at publish time in the meantime. -->
